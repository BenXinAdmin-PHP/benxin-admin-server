...
// +----------------------------------------------------------------------
// | @project   BenXinAdmin
// | @mission   管理员 — GET|POST|PUT|DELETE /admin/v1/admins[/:id|/:id/status]
// | @author    仗键天涯(daxing)
...
class Admin extends BxController
{
    ...
    public function save(): Response
    {
        ...
        return $this->success($admin, '新增成功');
    }
    ...
    public function update(int $id): Response
    {
        ...
        $admin = (new AdminService($this->app))->update($id, $this->request->param());
    ...
    {
        (new AdminService($this->app))->delete($id);
    ...
    public function status(int $id): Response
    {
        ...
        $admin = (new AdminService($this->app))->setStatus($id, (int) $this->request->param('status'));
